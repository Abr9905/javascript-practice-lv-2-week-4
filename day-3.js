...
const animals = [];
animals.push({ species: 'Dog', animalSounds: 'Bark' });
animals.push({ species: 'Cat', animalSounds: 'Meow' });
animals.push({ species: 'Cow', animalSounds: 'Moo' });

let animalSounds = '';
for (let i = 0; i < animals.length; i++) {
     animalSounds+= animals[i].animalSounds;
     animalSounds += ', ';
}
